  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url() ?>index.php/page" class="d-block">Hi, <?php echo $this->session->userdata('ses_nama') ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <?php if($this->session->userdata('ses_job')=='sales'):?>
            <li class="nav-item <?php echo ($this->session->userdata('ses_page')=='received_invoice') ? 'actived' : '' ; ?>">
              <a href="<?php echo base_url() ?>index.php/page/index" class="nav-link">
