  ...
  <div class="modal fade" id="Mod_Rcvd_Info" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog ">
      <div class="modal-content" >
        ...
        <div class="modal-header bg-primary">
          <h5 class="modal-title  text-white" >FABRIC RECEIVED INFORMATION</h5>
          <button type="button" class="close" data-dismiss="modal" >
            <span aria-hidden="true" style="color:white;">X</span>
          </button>
        </div>
...
$("#m_info").click(function () {
  ...
  alert($("#t_saldo_rcv").val());


  // disable click outside
  $('#Mod_Rcvd_Info').modal({backdrop: 'static', keyboard: false});
      ...
      success : function(data){
        if (data.length > 0 ){
          ...
          var total = 0;
            ...
            //TOTAL
            html += "<tr> " +
                    "<th scope='col' colspan='2'> <span>TOTAL RECEIVED (FINAL)</span> </th> " +
