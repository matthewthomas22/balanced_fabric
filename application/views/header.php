...
<!-- style="
// echo ($this->session->userdata('ses_page')=='fab_issued') ? 'width:4300px;' : 'width:3600px;' ;
" -->
  <head>
    <meta charset="utf-8">
    <title></title>
  ...
  <body>
    ...
    <nav id ="nav_menu" class="main-header navbar navbar-expand navbar-dark navbar-cyan">
      ...
      <?php elseif($this->session->userdata('ses_page') == 'fab_issued'): ?>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
          <span id="m_info">[ More Information ] </span>
          </a>
        </li>

      <?php elseif($this->session->userdata('ses_page') == 'fab_report'): ?>

        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
          <span id="m_generate_report">[ Generate Report ] </span>
          </a>
        </li>
